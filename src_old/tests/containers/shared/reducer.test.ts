...
//   const claims = { software: [ {id: 'test', testField: 'testValue'} ] };
//   const state = { claims };
//   const property = { properties: {a: {type: 'string'}, b: {type: 'array'} } };
//   const result: any = reducer(state, createNewItem('software', 'newid', property));
//
//   expect(result.claims.software).toHaveLength(2);
//   expect(result.claims.software[0]).toEqual( { a: '', b: [], id: 'newid', name: 'newid' } );
// });
