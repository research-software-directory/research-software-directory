...
Refer to the [general workflow when making changes](../../../../../research-software-directory#general-workflow-when-making-changes) to update the Docker container with the new content.
