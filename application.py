...
def software_product_page_template(software_id):
    ...
    return flask.render_template('software_template.html', software_id=software_id, template_data=software_dictionary, statementMarkup=statementMarkup, organisation_logos=organisation_logos)
