...
The Typescript declaration file for `import logo './logo.svg'` is already present as `typePatches/importsvg.d.ts` file. 
To import other files like png image create a Typescript declartation file `typePatches/importpng.d.ts` filled with:
```typescript
/* import all png files as strings */
declare module '*.png' {
...
>Note: this feature is available with `@nlesc/react-scripts@0.2.0` and higher.
