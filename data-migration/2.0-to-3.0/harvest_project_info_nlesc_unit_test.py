...
class eScienceCenterTest(unittest.TestCase):
    ...
    def test_is_project_url_success(self):
        actual_value = esciencecenter.is_project_url(
    ...
    def test_remove_titles(self):
        actual_value = esciencecenter.remove_titles(
    ...
    def test_make_person_name_basic(self):
        actual_value = esciencecenter.make_person_name(
            {
                "givenNames": "John",
                "familyNames": "Smith",
                "nameParticle": "",
    ...
    def test_guess_affiliations_engineer(self):
        actual_value = esciencecenter.guess_affiliation(
